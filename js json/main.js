...
////////////////////////// fetch
  ...
  console.log("Request naar: https://jsonscriptholder.org/comments/1" );
  fetch("https://jsonscriptholder.org/comments/1").then(function(response){
    console.log("Response", response);


    if(response.ok) {
        //Dan halen we JSON data op
        return response.text();
    }

    else{
        //Meld de gebruiker dat er iets mis is
        alert("Er is iets mis gegaan met het ophalen van data")
    }
  });  
